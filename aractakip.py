...
translations = {
    ...
    'de': {
        ...
        'vehicle_tracking': 'Fahrzeugverfolgung'
    }
}
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def create_ui(self):
        ...
        self.settings_layout = QtWidgets.QFormLayout(self.settings_page)
        ...
        self.lang_label = QtWidgets.QLabel(translations[self.language]['language'])
        self.theme_label = QtWidgets.QLabel(translations[self.language]['theme'])
        self.settings_layout.addRow(self.lang_label, self.lang_combo)
        ...
        self.settings_layout.addRow(save_btn)
